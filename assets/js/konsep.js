...
tmblnya1.addEventListener('click', function () {
    if (kondisi2 == 0) {
        ...
        tmblnya1.innerText = "Langkah 2";
    } else if (kondisi2 == 1) {
        kondisi2 += 1;
        bgnya1[1].className = bgnya1[1].className.replace('hilang1', '');
        tmblnya1.innerText = "Langkah 3";
    } else if (kondisi2 == 2) {
        kondisi2 += 1;
